...
<template>
	<div class="relative w-full h-full flex flex-col sm:flex-row">
		...
		class="relative w-full sm:w-1/2 flex flex-col justify-center items-center space-y-6 p-12 bg-black">
			<h5 class="text-[18px] sm:text-[32px] font-bold tracking-[4px] text-[#F0B90B]">百大DJ降臨 BB TAIPEI</h5>
		</div>
	</div>
	...
	<div class="w-full h-full flex flex-col sm:flex-row">
		...
		class="w-full sm:w-1/2 flex flex-col justify-center items-center space-y-6 p-12 bg-black">
			<h5 class="text-[18px] sm:text-[32px] font-bold tracking-[4px] text-[#F0B90B]">引領潮流韓風炸翻全場</h5>
		</div>
	</div>
